      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-0 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-8 w-auto" src={imgLib} alt="" style={{width: "170px", height:"170px"}}/>
          </a>
        </div>
        <div className="flex lg:hidden">
          ...
          >
            ...
            <Bars3Icon className="h-6 w-6 mr-5" aria-hidden="true" style={{color: 'white'}}/>
          </button>
        </div>
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-black-900">
              Library
              <ChevronDownIcon className="h-5 w-5 flex-none text-grey-400" aria-hidden="true" />
            </Popover.Button>
