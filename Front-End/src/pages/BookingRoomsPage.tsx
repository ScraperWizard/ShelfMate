...
const MeetingRoomsPage: React.FC = () => {
    ...
    return (
        ...
        <div className="container mx-auto flex flex-col items-center h-screen mt-10" data-name="meeting-room">
            ...
            <div className="mb-4">
            <Link to="/meeting-rooms" className="mr-4 bg-blue-500 hover:bg-blue-700 transition duration-300 ease-in-out text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Book Room</Link>
